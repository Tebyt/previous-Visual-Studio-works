...
public:
	...
	virtual MsgThreadPool::_Key *AddNode(ZNetServerModule *pModule,ContextKey *pKey,ZNet2::LPZNetMsgHead pMsg,int iMsgLen) = 0;
...
public:
	...
	virtual MsgThreadPool::_Key *AddNode(ZNetServerModule *pModule,ContextKey *pKey,ZNet2::LPZNetMsgHead pMsg,int iMsgLen);

	virtual void DelNode(MsgThreadPool::_Key *Node);
};

template<int MSG_SIZE,int LINK_SIZE,int LINK_ADD_SIZE>
MsgThreadPool::_Key *MsgPool<MSG_SIZE,LINK_SIZE,LINK_ADD_SIZE>::AddNode(ZNetServerModule *pModule,ContextKey *pKey,ZNet2::LPZNetMsgHead pMsg,int iMsgLen)
{
