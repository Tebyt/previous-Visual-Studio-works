...
typedef ZNet2::ZNetMsg<_GCS_Logout>	GCS_Logout;
...
typedef ZNet2::ZRequestMsg<_GCS_GetServerList>	GCS_GetServerList;
...
typedef ZNet2::ZNetMsg<_GCS_Ret>	GCS_Ret;
...
typedef ZNet2::ZRequestMsg<_GCS_UserData>	GCS_UserData;
...
typedef ZNet2::ZNetMsg<_GCS_US_ServerData>	GCS_US_ServerData;

//GCS_US_MSG_SERVERLISTEND
typedef ZNet2::ZNetMsg<ZNet2::null_type>	GCS_ServerListEnd;
...
typedef ZNet2::ZNetMsg<_GCS_ServerLogin> GCS_ServerLogin;
...
typedef ZNet2::ZRequestMsg<_GCS_ComeIn>	GCS_ComeIn;
...
typedef ZNet2::ZNetMsg<_GCS_ServerData> GCS_ServerData;

//GCS_GSS_MSG_RETCOMEIN
typedef ZNet2::ZRequestMsg<ZNet2::null_type> GCS_RetComeIn;
