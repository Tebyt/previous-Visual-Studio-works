...
typedef ZNet2::ZRequestMsg<_LoginServerLogin> LoginServerLogin;

//Reg msg
typedef ZNet2::ZRequestMsg<ZUserInfo> LoginServerReg;
...
typedef ZNet2::ZRequestMsg<_LoginServerRet> LoginServerRet;
