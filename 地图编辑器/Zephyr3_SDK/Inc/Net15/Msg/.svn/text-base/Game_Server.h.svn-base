...
typedef ZNet2::ZNetMsg<_GS_Hall_ComeIn>	GS_Hall_ComeIn;
...
typedef ZNet2::ZNetMsg<_GS_Hall_YourGameData_SC>	GS_Hall_YourGameData_SC;
...
typedef ZNet2::ZNetMsg<_GS_Hall_GameData_SC>	GS_Hall_GameData_SC;

//GS_HALL_MSG_USERCOMEIN_SC
typedef ZNet2::ZNetMsg<_GS_Hall_UserList_SC>	GS_Hall_UserComeIn_SC;
...
typedef ZNet2::ZNetMsg<_GS_Hall_UserLeft>	GS_Hall_UserLeft;
...
typedef ZNet2::ZNetMsg<_GS_Hall_Chat>	GS_Hall_Chat;
...
typedef ZNet2::ZNetMsg<_GS_Hall_ServerInfo>	GS_Hall_ServerInfo;
...
typedef ZNet2::ZNetMsg<_GS_Hall_Room_UserIn>	GS_Hall_Room_UserIn;
...
typedef ZNet2::ZNetMsg<_GS_Hall_Room_UserOut>	GS_Hall_Room_UserOut;
...
typedef ZNet2::ZNetMsg<_GS_Hall_UserReady>	GS_Hall_UserReady;
...
typedef ZNet2::ZNetMsg<_GS_Hall_Room_GameEnd>	GS_Hall_Room_GameEnd;

//GS_HALL_MSG_USERCOMEOK
typedef ZNet2::ZNetMsg<ZNet2::null_type>	GS_Hall_UserComeOK;
...
template<>
struct GS_RoomMsg<ZNet2::null_type>{
	WORD	RoomID;
};

typedef GS_RoomMsg<ZNet2::null_type>	_GS_RoomMsg_Base;
typedef ZNet2::ZNetMsg<_GS_RoomMsg_Base>	GS_RoomMsg_Base;
...
typedef ZNet2::ZNetMsg<_GS_Room_Connect>	GS_Room_Connect;
...
typedef ZNet2::ZNetMsg<_GS_Room_ComeIn>	GS_Room_ComeIn;

//GS_ROOM_MSG_WATCHERCOMEIN
typedef ZNet2::ZNetMsg<_GS_Room_ComeIn>	GS_Room_WatcherComeIn;

//GS_ROOM_MSG_LEFT
typedef ZNet2::ZNetMsg<_GS_RoomMsg_Base>	GS_Room_Left;

//GS_ROOM_MSG_IAMREADY
typedef ZNet2::ZNetMsg<_GS_RoomMsg_Base>	GS_Room_IAmReady;

//GS_ROOM_MSG_SURRENDER
typedef ZNet2::ZNetMsg<_GS_RoomMsg_Base>	GS_Room_Surrender;
...
typedef ZNet2::ZNetMsg<_GS_Room_User_TimeOut>	GS_Room_User_TimeOut;

//GS_ROOM_MSG_TIMEOUT_ERROR
typedef ZNet2::ZNetMsg<__GS_Room_User_TimeOut>	GS_Room_User_TimeOutError;

//GS_ROOM_MSG_COMEINOK
typedef ZNet2::ZNetMsg<_GS_Room_ComeIn>	GS_Room_ComeInOK;

//GS_ROOM_MSG_COMEINFAIL
typedef ZNet2::ZNetMsg<ZNet2::null_type>	GS_Room_ComeInFail;

//GS_ROOM_MSG_WATCHOK
typedef ZNet2::ZNetMsg<_GS_Room_ComeIn>	GS_Room_WatcherComeInOK;

//GS_ROOM_MSG_WATCHFAIL
typedef ZNet2::ZNetMsg<ZNet2::null_type>	GS_Room_WatcherComeInFail;

//GS_ROOM_MSG_CHAT
typedef GS_RoomMsg<_GS_Hall_Chat>	_GS_Room_Chat;
typedef ZNet2::ZNetMsg<_GS_Room_Chat>	GS_Room_Chat;

//GS_ROOM_MSG_CHATDATA
typedef ZNet2::ZNetMsg<_GS_Hall_Chat>	GS_Room_ChatData;
...
typedef ZNet2::ZNetMsg<_GS_Room_UserRunAway>		GS_Room_UserRunAway;
...
//	func
/*
inline void _GameServer_SetMsgHead(ZNet2::LPZNetMsgHead pHead,WORD Size,BYTE State,BYTE ID,
	BYTE AssistantID)
{
	pHead->SetHead(Size,GAME_SERVER_MSG,AssistantID);
